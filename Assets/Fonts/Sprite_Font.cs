...
public class Sprite_Font : MonoBehaviour
{
    ...
    private void ConvertStringToSprites(string stringToConvert)
    {
        ...
        letterContainer.GetComponent<RectTransform>().SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, stringToConvert.Length * sprites[0].rect.width / sprites[0].pixelsPerUnit);
    }
